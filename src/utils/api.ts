...
export const videoSources: VideoSource[] = [
  {
    key: 'embed',
    name: 'Embed (Default)',
    getMovieUrl: (id: number) => `https://www.2embed.cc/embed/tmdb/movie?id=${id}`,
  ...
  },
  {
    key: 'multiembed',
    name: 'MultiEmbed',
    getMovieUrl: (id: number) => `https://multiembed.mov/directstream.php?video_id=${id}&tmdb=1`,
    getTVUrl: (id: number, season: number, episode: number) => 
  ...
  },
  {
    key: 'vidsrc',
    name: 'VidSrc',
    getMovieUrl: (id: number) => `https://vidsrc.me/embed/movie?tmdb=${id}`,
    getTVUrl: (id: number, season: number, episode: number) => 
  ...
  },
  {
    key: 'dbgo',
    name: 'DBGO',
    getMovieUrl: (id: number) => `https://dbgo.fun/imdb.php?id=${id}`,
    getTVUrl: (id: number, season: number, episode: number) => 
      `https://dbgo.fun/tv-imdb.php?id=${id}&s=${season}&e=${episode}`
  },
  {
    key: 'gomo',
    name: 'GoMovies',
    getMovieUrl: (id: number) => `https://gomo.to/movie/${id}`,
    getTVUrl: (id: number, season: number, episode: number) => 
      `https://gomo.to/show/${id}/${season}/${episode}`
  },
  {
    key: 'custom-api',
    name: 'Direct Stream',
