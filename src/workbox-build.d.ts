...
/**
 * Type definitions for workbox-build
 * Used by vite-plugin-pwa
 */
...
declare module 'workbox-build' {
  export interface CustomPluginAPI {
    ...
    requestWillFetch?: (details: { event: FetchEvent & { preloadResponse?: Promise<Response> } }) => Promise<Request | Response>;
